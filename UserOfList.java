...
*/
        ...
        list.add(2, "u");
        /*
        System.out.println(list.rear.getPreviousNode().getPreviousNode());
        System.out.println(list.rear.getPreviousNode());
        System.out.println(list.rear);
*       */

        System.out.println(list.toStringReversed() + " expecting: [u`t`S]");

        list.add(3, "y");

        System.out.println(list.toStringReversed() + " expecting: [y`u`t`S]");

        list.remove(2);

        System.out.println(list.toStringReversed() + " expecting: [y`t`S]");

        list.remove(2);

        System.out.println(list.toStringReversed() + " expecting: [t`S]");
    }
